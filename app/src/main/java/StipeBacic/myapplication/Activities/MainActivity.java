package StipeBacic.myapplication.Activities;
...
import StipeBacic.myapplication.Core.MainActivityContract;
import StipeBacic.myapplication.Core.MainActivityPresenter;
import StipeBacic.myapplication.Model.Player;
import StipeBacic.myapplication.R;
import StipeBacic.myapplication.Utils.Config;
import StipeBacic.myapplication.Utils.CreatePlayerDialog;
import StipeBacic.myapplication.Utils.RecyclerViewAdapter;
import StipeBacic.myapplication.Utils.UpdatePlayerDialog;

public class MainActivity extends AppCompatActivity implements CreatePlayerDialog.createPlayerDialogListener,
        MainActivityContract.View,
        UpdatePlayerDialog.UpdatePlayerDialogListener, RecyclerViewAdapter.onPlayerListener{
    ...
    public void onCreatePlayerSuccessful() {
        ...
        Toast.makeText(MainActivity.this, "Created new Player", Toast.LENGTH_LONG).show();
    }
    ...
    public void onPlayerDelete(Player player) {
        ...
        Toast.makeText(MainActivity.this, "Deleted" + player.getName(), Toast.LENGTH_SHORT).show();
    }
